...
def ofa_large_architecture(args):
    args.adapter_list = getattr(args, "adapter_list", "1,3,5,7,9,11")
    args.adapter_transformer_layers = getattr(args, "adapter_transformer_layers", 2)
...
def ofa_base_architecture(args):
    args.adapter_list = getattr(args, "adapter_list", "1,3,5")
