  ...
  for lr in {1e-4,}; do
    ...
    for patch_image_size in {480,}; do
      ...
      CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 -m torch.distributed.launch --nproc_per_node=8 --master_port=${MASTER_PORT} ../../train.py \
          ...
          --adapter-num=3 \
          --combine-adapter-path=refcoco_checkpoints/large_100_1e-4_480_16/checkpoint_best.pt,refcocoplus_checkpoints/large_100_1e-4_480_16/checkpoint_best.pt,refcocog_checkpoints/large_100_1e-4_480_16/checkpoint_best.pt \
          --disable-entangle \
          --fp16 \
